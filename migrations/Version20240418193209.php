 ...
 */
final class Version20240418193209 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE klant ADD contract_details VARCHAR(255) DEFAULT NULL, ADD startdatum DATE NOT NULL, ADD einddatum DATE NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE telefoonnummer telefoonnummer VARCHAR(255) NOT NULL, CHANGE type type VARCHAR(255) NOT NULL, CHANGE contract_id status VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE klant DROP contract_details, DROP startdatum, DROP einddatum, CHANGE type type VARCHAR(255) DEFAULT NULL, CHANGE telefoonnummer telefoonnummer VARCHAR(20) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE status contract_id VARCHAR(255) NOT NULL');
    }
}
