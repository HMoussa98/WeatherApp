 ...
 */
class getKlantRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\KlantRepository' shared autowired service.
     *
     * @return \App\Repository\KlantRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'KlantRepository.php';

        return $container->privates['App\\Repository\\KlantRepository'] = new \App\Repository\KlantRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
