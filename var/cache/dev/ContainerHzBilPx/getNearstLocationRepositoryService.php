 ...
 */
class getNearstLocationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NearstLocationRepository' shared autowired service.
     *
     * @return \App\Repository\NearstLocationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NearstLocationRepository.php';

        return $container->privates['App\\Repository\\NearstLocationRepository'] = new \App\Repository\NearstLocationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
