 ...
 */
class getWeatherRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\WeatherRepository' shared autowired service.
     *
     * @return \App\Repository\WeatherRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WeatherRepository.php';

        return $container->privates['App\\Repository\\WeatherRepository'] = new \App\Repository\WeatherRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
