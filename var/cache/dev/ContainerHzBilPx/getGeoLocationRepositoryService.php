 ...
 */
class getGeoLocationRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GeoLocationRepository.php';

        return $container->privates['App\\Repository\\GeoLocationRepository'] = new \App\Repository\GeoLocationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
